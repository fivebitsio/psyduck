...
# Psyduck Analytics Platform

Welcome to Psyduck Analytics, a privacy-friendly, open-source analytics platform designed for modern websites and applications. Unlike traditional analytics tools that compromise user privacy, Psyduck focuses on collecting valuable insights while respecting user privacy and data protection regulations.
...
Traditional analytics platforms often collect excessive personal data, track users across the web, and create privacy concerns for your visitors. Psyduck eliminates these issues by:
...
Continue with the [Installation Guide](/docs/installation) to set up your Psyduck Analytics platform today.
