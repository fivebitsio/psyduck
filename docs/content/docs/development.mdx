...
For information on deploying the Psyduck Analytics, see the [Deployment](/docs/deployment) section which covers general deployment steps and platform-specific instructions including Hetzner.
