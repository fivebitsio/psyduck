...
function createAnalyticsService(deps: deps) {
  ...
  async function getVisitsByDevice(from: string, to: string): Promise<VisitsByDevice> {
  ...
  async function getVisitsByPage(from: string, to: string): Promise<VisitsByPage[]> {
